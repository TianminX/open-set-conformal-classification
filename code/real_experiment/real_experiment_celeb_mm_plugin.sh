...
#   n_ref n_test calib_num alpha_total lambda_weight n_label_total k_top k_bot \
#   batch splitting_method_flag [grid_size]
python3 real_experiment_celeb_mm_plugin.py "$@"
