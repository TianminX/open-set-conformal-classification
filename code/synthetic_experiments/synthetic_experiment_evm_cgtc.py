...
# Tuned mode:  python synthetic_experiment_evm_cgtc.py theta n_ref n_test calib_num alpha_total lambda_weight batch_num tuning_method_flag
# Fixed mode:  python synthetic_experiment_evm_cgtc.py theta n_ref n_test calib_num alpha_total lambda_weight batch_num -1 alpha_class alpha_unseen alpha_seen

if len(sys.argv) < 9:
    print("Error: incorrect number of parameters.")
    print("Usage (tuned):  python synthetic_experiment_evm_cgtc.py theta n_ref n_test calib_num alpha_total lambda_weight batch_num tuning_method_flag")
    print("Usage (fixed):  python synthetic_experiment_evm_cgtc.py theta n_ref n_test calib_num alpha_total lambda_weight batch_num -1 alpha_class alpha_unseen alpha_seen")
    quit()
...
if tuning_method_flag == 0:
    ...
    if len(sys.argv) != 12:
        ...
        print("Usage: python synthetic_experiment_evm_cgtc.py theta n_ref n_test calib_num alpha_total lambda_weight batch_num -1 alpha_class alpha_unseen alpha_seen")
        quit()
...
# OpenSetKNNEVM: KNN + EVM margin-based Weibull for unseen labels
...
# For alpha tuning, use random splitting full with the EVM classifier
methods_list_tuning = {
...
def analyze_data(X_ref, Y_ref, X_test, Y_test, classifiers_dict,
    ...
    """
    Run each EVM-CGTC classifier through the full CGTC pipeline
